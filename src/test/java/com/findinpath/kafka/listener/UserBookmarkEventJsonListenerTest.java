...
/**
 * This tests checks whether the messages sent in JSON format over the
...
@SpringBootTest
@ActiveProfiles("test")
public class UserBookmarkEventJsonListenerTest {
	...
	@Value("${kafka.userBookmarkEventsJson.topic}")
	private String userBookmarkEventJsonTopic;
